...
Das Stay-open-Protokoll ist zeilenorientiert. Dateinamen oder Werte mit Zeilenumbrüchen verwenden deshalb einen isolierten Prozess mit strukturierten Argumenten. Binäre Vorschaubilder werden ebenfalls isoliert gelesen. Ausgabe ist pro Stream auf 32 MiB begrenzt, auch vor der vollständigen Zeilenallokation. Benutzerkonfiguration und fremde Perl-Umgebungsvariablen werden deaktiviert. Beim Beenden werden Worker kontrolliert beendet.
